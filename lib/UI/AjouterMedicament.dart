...
const AjouterMedicament({Key? key, String? detailsPath,  String? label}) : super(key: key);

  @override
  State createState() => _AjouterMedicamentState();
}


class _AjouterMedicamentState extends State {
  bool loading = false;
