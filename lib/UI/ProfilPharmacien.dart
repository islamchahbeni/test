...
const ProfilPharmacien({Key? key, String? detailsPath,  String? label}) : super(key: key);

  @override
  State createState() => _ProfilPharmacienState();
}


class _ProfilPharmacienState extends State {
  bool loading = false;
