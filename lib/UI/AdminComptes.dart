          ...
          ListView.builder(
                    ...
                    return
                        Column(children:<Widget> [
                          ListTile(
                        leading: const Icon(Icons.person_rounded,color:Color(0xFF56c596),size: 40,),
                        trailing:
                         SizedBox(
                        height: 30,
                        child:
                        ...
                        child:
                         FloatingActionButton.extended(
                                ...
                                onPressed: () {GoRouter.of(context).push('/ConsulterCompte');},
                              ),),),
                          title:
...
const AdminComptes({Key? key, String? detailsPath,  String? label}) : super(key: key);

  @override
  State createState() => _AdminComptesState();
}


class _AdminComptesState extends State {
  @override
        ...
        Container(
          ...
          Row(
            ...
            Padding(
                  ...
                  child:
                    Text( 'Les comptes',style: TextStyle(fontSize: 15,fontWeight: FontWeight.w100,color: Color(0xFF35617f)),textAlign: TextAlign.left,),
            ...
            Padding(
                  ...
                  child:
                    MaterialButton(
                          ...
                          onPressed: () {GoRouter.of(context).push('/AjouterCompte');},
