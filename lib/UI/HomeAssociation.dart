...
class HomeAssociation extends StatefulWidget {
const HomeAssociation({Key? key, String? detailsPath,  String? label}) : super(key: key);

  @override
  State createState() => _HomeAssociationState();
}


class _HomeAssociationState extends State {
  @override
        ...
        Container(
          ...
          Row(
            ...
            Padding(
                  ...
                  child:
                    Text( 'Les lots',style: TextStyle(fontSize: 15,fontWeight: FontWeight.w100,color: Color(0xFF35617f)),textAlign: TextAlign.left,),
            ...
            Padding(
                  ...
                  child:
                    MaterialButton(
                          onPressed: () {GoRouter.of(context).push('/MapAssociation');},
