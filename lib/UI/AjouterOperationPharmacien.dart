...
class AjouterOperationPharmacien extends StatefulWidget {
const AjouterOperationPharmacien({Key? key, String? detailsPath,  String? label}) : super(key: key);

  @override
  State createState() => _AjouterOperationPharmacienState();
}


class _AjouterOperationPharmacienState extends State {
  final items = ['1', '2', '3'];
