...
class AjouterCompte extends StatefulWidget {
const AjouterCompte({Key? key, String? detailsPath,  String? label}) : super(key: key);

  @override
  State createState() => _AjouterCompteState();
}


class _AjouterCompteState extends State {
  bool loading = false;
