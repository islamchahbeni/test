...
class ProfilAdherent extends StatefulWidget {
const ProfilAdherent({Key? key, String? detailsPath,  String? label}) : super(key: key);

  @override
  State createState() => _ProfilAdherentState();
}


class _ProfilAdherentState extends State {
  bool loading = false;
                        ...
                        children: [
                          ...
                          name = value;
                                  ...
                                  decoration: InputDecoration(
                                    contentPadding:
                                        EdgeInsets.symmetric(vertical: 10),
                                    hintText: 'Numéro contrat',
                                    labelText: 'Numéro contrat',
                                    labelStyle: TextStyle(
                                      fontSize: 13,
                                      color: Color(0xFF205072),
                                    ),
